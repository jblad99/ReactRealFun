...
function Info() {
  return (
  <p>
    This website shows information about all the different teams in NCAA Basketball. 
    Check out more information on each team to predict who will win March Madness this year!
    Go Zags!
  </p>
  );
}
